...
$(document).ready(function() {
	...
	$('.c1, .c2, .c3, .c4, .c5, .c6, .c7, .c8, .c9, .c10, .c11, .c12, .c13, .c14').click(function() {
		if ($(this).hasClass("c1")) {
			$('#container, #circle, .classic, .choose, .t24, .t12').css("background","#333");
		} else if ($(this).hasClass("c2")) {
			$('#container, #circle, .classic, .choose, .t24, .t12').css("background","#1A1A1A");
		} else if ($(this).hasClass("c3")) {
			$('#container, #circle, .classic, .choose, .t24, .t12').css("background","#006e69");
		} else if ($(this).hasClass("c4")) {
			$('#container, #circle, .classic, .choose, .t24, .t12').css("background","#338000");
		} else if ($(this).hasClass("c5")) {
			$('#container, #circle, .classic, .choose, .t24, .t12').css("background","#1BA1E2");
		} else if ($(this).hasClass("c6")) {
			$('#container, #circle, .classic, .choose, .t24, .t12').css("background","#3B5998");
		} else if ($(this).hasClass("c7")) {
			$('#container, #circle, .classic, .choose, .t24, .t12').css("background","#393393");
		} else if ($(this).hasClass("c8")) {
			$('#container, #circle, .classic, .choose, .t24, .t12').css("background","#441650");
		} else if ($(this).hasClass("c9")) {
			$('#container, #circle, .classic, .choose, .t24, .t12').css("background","#d25423");
		} else if ($(this).hasClass("c10")) {
			$('#container, #circle, .classic, .choose, .t24, .t12').css("background","#8f0202");
		} 
	});
	...
	$('.classic').click(function() {
		...
		$('.classic, .t24, .t12, .choose').css("background","none");
	});
